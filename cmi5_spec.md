...
<table>
  ...
  <tr><th align="right" nowrap>Value Space:</th><td>Decimal value between 0 and 1, including 1 but excluding 0.</td></tr>
  ...
  <tr>
    ...
    <td valign="top"><p><strong>Description:</strong> A score used by the LMS to determine passing or failure of judged activity in the AU (if the AU has scoring).</p>
      ...
      <ul>
        ...
        <li>The "masteryScore" is a scaled, decimal value between 0 and 1, including 1 but excluding 0.</li>
      </ul>
